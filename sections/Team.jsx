...
const World = () => (
  <section id="o" className={`${styles.paddings} relative z-10`}>
    <motion.div
    ...
    >
      ...
      >
       <TypingText title="| Das Team" textStyles="text-center" />
      <TitleText
        title={<>Das Team</>}
        textStyles="text-center"
      />
         <div id="bgGradient05" className="">
            ...
            <li key={person.name}>
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="space-y-1 rounded-2xl p-1 text-gray-100 text-3xl font-black leading-6 lg:bg-black/20">
                    <h3>{person.name}</h3>
